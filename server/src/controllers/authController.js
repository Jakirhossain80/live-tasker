...
const validateUpdateMeBody = (body) => {
...
const setRefreshTokenCookie = (res, refreshToken) => {
    res.cookie(authService.refreshTokenCookieName, refreshToken, {
...
const refresh = asyncHandler(async (req, res) => {
    const result = await authService.refresh(req.cookies[authService.refreshTokenCookieName]);
    setRefreshTokenCookie(res, result.tokens.refreshToken);
    res.json({
        success: true,
...
const logout = asyncHandler(async (_req, res) => {
    res.clearCookie(authService.refreshTokenCookieName, refreshCookieBaseOptions);
    res.json({
        success: true,
