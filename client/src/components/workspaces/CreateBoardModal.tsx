...
function CreateBoardModal({ isOpen, isSubmitting, errorMessage, onClose, onSubmit }: CreateBoardModalProps) {
      ...
      <section className="w-full max-w-lg rounded-xl border border-slate-200 bg-white shadow-xl">
        <div className="flex items-center justify-between gap-4 border-b border-slate-200 px-5 py-4">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">Add a board for tracking tasks and delivery work.</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 p-5">
          ...
          <label className="block">
            ...
            <textarea
              ...
              rows={4}
              maxLength={500}
              placeholder="Plan sprint priorities, task ownership, and delivery progress."
