...
const validateUpdateWorkspaceBody = (body) => {
...
const validateUpdateMemberBody = (body) => {
...
const getWorkspaceById = asyncHandler(async (req, res) => {
    const workspace = await workspaceService.getWorkspaceById(getRouteParam(req, "workspaceId"), getAuthUserId(req));
    res.json({
        success: true,
        data: {
            workspace,
